...
import { saveCalculation, saveHistory } from '../database.js'
...
router.post('/roi', (req: AuthRequest, res: Response) => {
  ...
  saveHistory(req.userId!, 'roi', req.body, result)
  res.json(result)
})
...
router.post('/pricing', (req: AuthRequest, res: Response) => {
  ...
  saveHistory(req.userId!, 'pricing', req.body, result)
  res.json(result)
})
...
router.post('/profit', (req: AuthRequest, res: Response) => {
  ...
  saveHistory(req.userId!, 'profit', req.body, result)
  res.json(result)
})
...
router.post('/ad-roi', (req: AuthRequest, res: Response) => {
  ...
  saveHistory(req.userId!, 'ad-roi', req.body, result)
  res.json(result)
})
...
router.post('/strategy', (req: AuthRequest, res: Response) => {
  ...
  saveHistory(req.userId!, 'strategy', req.body, result)
  res.json(result)
})
...
router.post('/listing-roi', (req: AuthRequest, res: Response) => {
  ...
  saveHistory(req.userId!, 'listing-roi', req.body, result)
  res.json(result)
})
